...
# Add / remove / edit entries here for every dataset you want to pull in.
# workspace + project + version come from each dataset's Roboflow page
# (visible in the code snippet Roboflow shows on the right side of the page).
DATASETS_TO_DOWNLOAD = [
    {'name': 'my_original_food_dataset', 'workspace': 'project-4lmm2',  'project': 'foods-qshht',                 'version': 7},
    {'name': 'indian_food',              'workspace': 'project-z0tql',  'project': 'indian-food-detection-kzw9g', 'version': 1},
    {'name': 'fast_food',                'workspace': 'algebra',        'project': 'fast-food-finder',            'version': 1},
    {'name': 'fruits_vegetables',        'workspace': 'datasets-wqqwv', 'project': 'fruits-and-vegetables-un1ow', 'version': 1},
    # Add your own finds the same way, e.g.:
    # {'name': 'my_find', 'workspace': '...', 'project': '...', 'version': 1},
]

downloaded_datasets = {}   # name -> dataset object (has .location)
all_classes = {}           # name -> list of class names
...
TEST_IMAGE = os.path.join(DATASET_DIR, 'test_plate.jpg')  # <-- change to your test photo's path
